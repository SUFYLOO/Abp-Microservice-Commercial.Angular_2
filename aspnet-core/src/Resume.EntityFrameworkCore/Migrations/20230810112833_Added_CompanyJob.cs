...
{
    /// <inheritdoc />
    public partial class AddedCompanyJob : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobOpen = table.Column<bool>(type: "bit", nullable: false),
                    MailTplId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SMSTplId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCompanyJobs", x => x.Id);
                });
        }
