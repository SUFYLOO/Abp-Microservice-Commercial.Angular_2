...
{
    /// <inheritdoc />
    public partial class AddedCompanyJobLanguageCondition : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppCompanyJobLanguageConditions",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCompanyJobLanguageConditions", x => x.Id);
                });
        }
