...
{
    /// <inheritdoc />
    public partial class AddedCompanyJobPay : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppCompanyJobPays",
                columns: table => new
                {
                    ...
                    JobPayTypeCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    DateReal = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCompanyJobPays", x => x.Id);
                });
        }
