...
{
    /// <inheritdoc />
    public partial class AddedShareDefault : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppShareDefaults",
                columns: table => new
                {
                    ...
                    FormTypeCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppShareDefaults", x => x.Id);
                });
        }
