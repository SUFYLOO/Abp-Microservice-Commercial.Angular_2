...
{
    /// <inheritdoc />
    public partial class AddedSystemUserNotify : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppSystemUserNotifys",
                columns: table => new
                {
                    ...
                    NotifyTypeCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSystemUserNotifys", x => x.Id);
                });
        }
