...
{
    /// <inheritdoc />
    public partial class AddedUserCompanyBind : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppUserCompanyBinds",
                columns: table => new
                {
                    ...
                    CompanyInvitationsId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserCompanyBinds", x => x.Id);
                });
        }
