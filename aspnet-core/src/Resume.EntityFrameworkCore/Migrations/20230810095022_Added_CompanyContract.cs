...
{
    /// <inheritdoc />
    public partial class AddedCompanyContract : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppCompanyContracts",
                columns: table => new
                {
                    ...
                    PointsPay = table.Column<int>(type: "int", nullable: false),
                    PointsGift = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCompanyContracts", x => x.Id);
                });
        }
