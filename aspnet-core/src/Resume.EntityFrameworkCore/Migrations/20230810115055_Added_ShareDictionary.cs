...
{
    /// <inheritdoc />
    public partial class AddedShareDictionary : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppShareDictionarys",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ShareLanguageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShareTagId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    Key3 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppShareDictionarys", x => x.Id);
                });
        }
