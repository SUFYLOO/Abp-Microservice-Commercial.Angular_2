...
{
    /// <inheritdoc />
    public partial class AddedResumeDependents : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppResumeDependentss",
                columns: table => new
                {
                    ...
                    KinshipCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppResumeDependentss", x => x.Id);
                });
        }
