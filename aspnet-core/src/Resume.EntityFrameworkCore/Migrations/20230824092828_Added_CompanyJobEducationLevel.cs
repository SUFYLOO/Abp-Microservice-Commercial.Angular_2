...
{
    /// <inheritdoc />
    public partial class AddedCompanyJobEducationLevel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppCompanyJobEducationLevels",
                columns: table => new
                {
                    ...
                    EducationLevelCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCompanyJobEducationLevels", x => x.Id);
                });
        }
