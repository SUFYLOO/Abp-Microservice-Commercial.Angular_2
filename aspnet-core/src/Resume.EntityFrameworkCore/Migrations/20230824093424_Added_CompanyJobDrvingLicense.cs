...
{
    /// <inheritdoc />
    public partial class AddedCompanyJobDrvingLicense : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppCompanyJobDrvingLicenses",
                columns: table => new
                {
                    ...
                    DrvingLicenseCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    HaveDrvingLicense = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCompanyJobDrvingLicenses", x => x.Id);
                });
        }
