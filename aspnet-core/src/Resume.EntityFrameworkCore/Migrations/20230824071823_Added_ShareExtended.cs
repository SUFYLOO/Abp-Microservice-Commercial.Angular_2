...
{
    /// <inheritdoc />
    public partial class AddedShareExtended : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppShareExtendeds",
                columns: table => new
                {
                    ...
                    Key4 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Key5 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppShareExtendeds", x => x.Id);
                });
        }
