        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameC = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    NameE = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    IdentityNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    BirthDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SexCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    BloodCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PlaceOfBirthCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
