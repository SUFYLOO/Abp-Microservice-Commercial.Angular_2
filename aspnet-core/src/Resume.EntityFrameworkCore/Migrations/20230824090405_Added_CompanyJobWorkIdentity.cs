...
{
    /// <inheritdoc />
    public partial class AddedCompanyJobWorkIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppCompanyJobWorkIdentities",
                columns: table => new
                {
                    ...
                    WorkIdentityCode = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCompanyJobWorkIdentities", x => x.Id);
                });
        }
