...
{
    /// <inheritdoc />
    public partial class AddedResumeDrvingLicense : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppResumeDrvingLicenses",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ResumeMainId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DrvingLicenseCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppResumeDrvingLicenses", x => x.Id);
                });
        }
