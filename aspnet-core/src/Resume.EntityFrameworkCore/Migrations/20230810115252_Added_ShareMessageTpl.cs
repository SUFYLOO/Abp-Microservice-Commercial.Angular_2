...
{
    /// <inheritdoc />
    public partial class AddedShareMessageTpl : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppShareMessageTpls",
                columns: table => new
                {
                    ...
                    TitleContents = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ContentMail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContentSMS = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppShareMessageTpls", x => x.Id);
                });
        }
