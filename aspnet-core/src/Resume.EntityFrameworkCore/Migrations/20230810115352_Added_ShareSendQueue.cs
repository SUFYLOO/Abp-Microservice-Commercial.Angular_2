...
{
    /// <inheritdoc />
    public partial class AddedShareSendQueue : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppShareSendQueues",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Key1 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Key2 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Key3 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SendTypeCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    FromAddr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ToAddr = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    TitleContents = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppShareSendQueues", x => x.Id);
                });
        }
