...
{
    /// <inheritdoc />
    public partial class AddedUserCompanyJobPair : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppUserCompanyJobPairs",
                columns: table => new
                {
                    ...
                    PairCondition = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserCompanyJobPairs", x => x.Id);
                });
        }
