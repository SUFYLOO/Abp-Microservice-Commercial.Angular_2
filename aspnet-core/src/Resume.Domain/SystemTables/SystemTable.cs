...
namespace Resume.SystemTables
{
    public class SystemTable : FullAuditedAggregateRoot<Guid>, IMultiTenant
    {
        ...
        public SystemTable(Guid id, string name, bool allowInsert, bool allowUpdate, bool allowDelete, bool allowSelect, bool allowExport, bool allowImport, bool allowPage, bool allowSort, DateTime dateA, DateTime dateD, int sort, string status, string extendedInformation = null, string note = null)
        {
