...
namespace Resume.UserCompanyJobFavs
{
    public class UserCompanyJobFav : FullAuditedAggregateRoot<Guid>, IMultiTenant
    {
        ...
        public UserCompanyJobFav(Guid id, Guid userMainId, Guid companyJobId, string extendedInformation, DateTime dateA, DateTime dateD, int sort, string note, string status)
        {
