...
namespace Resume.ShareTags
{
    public class ShareTag : FullAuditedAggregateRoot<Guid>, IMultiTenant
    {
        ...
        public ShareTag(Guid id, string colorCode, string key1, string key2, string key3, string name, string tagCategoryCode, string extendedInformation = null, DateTime? dateA = null, DateTime? dateD = null, int? sort = null, string note = null, string status = null)
        {
