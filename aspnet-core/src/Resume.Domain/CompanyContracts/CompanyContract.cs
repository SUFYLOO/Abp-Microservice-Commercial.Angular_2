...
namespace Resume.CompanyContracts
{
    public class CompanyContract : FullAuditedAggregateRoot<Guid>, IMultiTenant
    {
        ...
        public CompanyContract(Guid id, Guid companyMainId, string planCode, int pointsTotal, int pointsPay, int pointsGift, string extendedInformation, DateTime dateA, DateTime dateD, int sort, string note, string status)
        {
