...
namespace Resume.UserCompanyJobPairs
{
    public class UserCompanyJobPairsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("9c1921c4-671b-4114-a132-1fdcf31ecfe1"),
                ...
                dateA: new DateTime(2005, 2, 6),
                dateD: new DateTime(2018, 9, 15),
                sort: 246069885,
            ...
            await _userCompanyJobPairRepository.InsertAsync(new UserCompanyJobPair
            (
                id: Guid.Parse("03d271f0-aa00-4d34-81b4-0224cf41b5ab"),
                ...
                dateA: new DateTime(2019, 11, 25),
                dateD: new DateTime(2018, 11, 16),
                sort: 1357486559,
