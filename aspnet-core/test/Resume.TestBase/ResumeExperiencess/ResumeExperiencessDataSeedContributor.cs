...
namespace Resume.ResumeExperiencess
{
    public class ResumeExperiencessDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("33926bdf-dca9-4403-a622-446d02427ae7"),
                ...
                dateA: new DateTime(2020, 10, 24),
                dateD: new DateTime(2007, 2, 12),
                sort: 554970573,
            ...
            await _resumeExperiencesRepository.InsertAsync(new ResumeExperiences
            (
                id: Guid.Parse("68429828-f1b5-40ab-87b5-3df674d1641b"),
                ...
                dateA: new DateTime(2008, 4, 6),
                dateD: new DateTime(2003, 3, 17),
                sort: 457697332,
