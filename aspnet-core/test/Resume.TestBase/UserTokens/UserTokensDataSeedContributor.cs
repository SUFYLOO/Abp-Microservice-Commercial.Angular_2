...
namespace Resume.UserTokens
{
    public class UserTokensDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("fe972314-7be5-47c3-808b-19bc06f69c04"),
                ...
                dateA: new DateTime(2013, 10, 10),
                dateD: new DateTime(2022, 9, 19),
                sort: 398128621,
            ...
            await _userTokenRepository.InsertAsync(new UserToken
            (
                id: Guid.Parse("14f9ddd3-28b2-4ed5-8555-0455c017f6da"),
                ...
                dateA: new DateTime(2013, 10, 19),
                dateD: new DateTime(2005, 1, 6),
                sort: 260804090,
