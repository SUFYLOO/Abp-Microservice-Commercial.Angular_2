...
namespace Resume.UserTokens
{
    public class UserTokensDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("6f37c737-f65e-407a-9fb5-17951a674e6d"),
                ...
                dateA: new DateTime(2010, 10, 18),
                dateD: new DateTime(2022, 9, 3),
                sort: 861161540,
            ...
            await _userTokenRepository.InsertAsync(new UserToken
            (
                id: Guid.Parse("6a0c9efc-8dd0-4777-a985-06e98278bc99"),
                ...
                dateA: new DateTime(2008, 11, 18),
                dateD: new DateTime(2015, 10, 16),
                sort: 2093337795,
