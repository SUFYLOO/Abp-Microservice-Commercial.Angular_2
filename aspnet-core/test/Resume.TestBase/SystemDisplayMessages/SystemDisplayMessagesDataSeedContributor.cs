...
namespace Resume.SystemDisplayMessages
{
    public class SystemDisplayMessagesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("b3a990b0-b0a1-4ca3-8641-960628fa31d9"),
                ...
                dateA: new DateTime(2011, 10, 3),
                dateD: new DateTime(2020, 5, 17),
                sort: 1127231703,
            ...
            await _systemDisplayMessageRepository.InsertAsync(new SystemDisplayMessage
            (
                id: Guid.Parse("10115326-f6b8-4864-b43e-9ec720731077"),
                ...
                dateA: new DateTime(2022, 9, 24),
                dateD: new DateTime(2009, 4, 6),
                sort: 1830178855,
