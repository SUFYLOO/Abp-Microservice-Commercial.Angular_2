...
namespace Resume.CompanyJobs
{
    public class CompanyJobsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("5e824e19-49ea-40a9-9ec7-c51baa709e70"),
                ...
                dateA: new DateTime(2018, 8, 19),
                dateD: new DateTime(2004, 8, 19),
                sort: 1319333832,
            ...
            await _companyJobRepository.InsertAsync(new CompanyJob
            (
                id: Guid.Parse("997dabd7-3aed-42b9-8c8d-eed9b1ce7de3"),
                ...
                dateA: new DateTime(2013, 9, 23),
                dateD: new DateTime(2008, 11, 7),
                sort: 1455744173,
