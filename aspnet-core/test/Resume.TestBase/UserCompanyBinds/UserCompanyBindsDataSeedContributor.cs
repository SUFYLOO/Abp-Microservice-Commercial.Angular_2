...
namespace Resume.UserCompanyBinds
{
    public class UserCompanyBindsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("195d488e-20b8-4dad-aa25-9ec64553b538"),
                ...
                dateA: new DateTime(2010, 7, 14),
                dateD: new DateTime(2021, 11, 9),
                sort: 81364909,
            ...
            await _userCompanyBindRepository.InsertAsync(new UserCompanyBind
            (
                id: Guid.Parse("7f6dfbf2-c1bb-4824-8f7f-c1987229524f"),
                ...
                dateA: new DateTime(2017, 8, 14),
                dateD: new DateTime(2000, 10, 26),
                sort: 683330283,
