...
namespace Resume.UserMains
{
    public class UserMainsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("ee94154c-0556-4e0a-93c1-f28111a9ea75"),
                ...
                systemUserRoleKeys: 720948314,
                allowSearch: true,
                dateA: new DateTime(2012, 2, 22),
            ...
            await _userMainRepository.InsertAsync(new UserMain
            (
                id: Guid.Parse("09628d9c-5356-40c0-9d68-0d8d484e2449"),
                ...
                systemUserRoleKeys: 74885790,
                allowSearch: true,
                dateA: new DateTime(2017, 8, 11),
