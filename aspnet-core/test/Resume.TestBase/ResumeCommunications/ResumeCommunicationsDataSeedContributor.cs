...
{
    public class ResumeCommunicationsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly IResumeCommunicationRepository _resumeCommunicationRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public ResumeCommunicationsDataSeedContributor(IResumeCommunicationRepository resumeCommunicationRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _resumeCommunicationRepository.InsertAsync(new ResumeCommunication
            (
                id: Guid.Parse("e229be8c-dc67-450d-a123-0c0c1c7c7bb5"),
                ...
                dateA: new DateTime(2021, 2, 20),
                dateD: new DateTime(2007, 2, 18),
                sort: 2094814690,
            ...
            await _resumeCommunicationRepository.InsertAsync(new ResumeCommunication
            (
                id: Guid.Parse("967c4913-2692-4921-8c73-796a944166a9"),
                ...
                dateA: new DateTime(2020, 11, 10),
                dateD: new DateTime(2001, 3, 22),
                sort: 452853499,
