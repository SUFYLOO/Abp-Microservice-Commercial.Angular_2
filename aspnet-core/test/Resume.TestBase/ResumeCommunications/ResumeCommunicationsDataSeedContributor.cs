...
namespace Resume.ResumeCommunications
{
    public class ResumeCommunicationsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("0ffb99ff-4942-4b72-9007-e1e200fdf9f6"),
                ...
                dateA: new DateTime(2015, 8, 18),
                dateD: new DateTime(2006, 2, 24),
                sort: 1890344816,
            ...
            await _resumeCommunicationRepository.InsertAsync(new ResumeCommunication
            (
                id: Guid.Parse("0667892f-9b7f-4689-afcf-abbde4c8d044"),
                ...
                dateA: new DateTime(2018, 1, 12),
                dateD: new DateTime(2019, 4, 6),
                sort: 1753004938,
