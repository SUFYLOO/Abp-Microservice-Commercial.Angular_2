...
namespace Resume.CompanyJobContents
{
    public class CompanyJobContentsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("cbda65df-3477-4a38-a9a5-2e004632c0a5"),
                ...
                peopleRequiredNumber: 206961244,
                ...
                dateA: new DateTime(2003, 7, 19),
                dateD: new DateTime(2005, 1, 9),
                sort: 357253953,
            ...
            await _companyJobContentRepository.InsertAsync(new CompanyJobContent
            (
                id: Guid.Parse("2d4a95d4-5c41-4c72-9998-c08f901162b6"),
                ...
                peopleRequiredNumber: 1339885477,
                peopleRequiredNumberUnlimited: true,
                ...
                dateA: new DateTime(2010, 5, 6),
                dateD: new DateTime(2002, 6, 23),
                sort: 1675751809,
