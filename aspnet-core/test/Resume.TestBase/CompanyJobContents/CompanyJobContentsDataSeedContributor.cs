...
namespace Resume.CompanyJobContents
{
    public class CompanyJobContentsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("766d6363-567e-4af6-b2fb-16fb6edfa4f3"),
                ...
                peopleRequiredNumber: 370168233,
                ...
                salaryMin: 2004812414,
                salaryMax: 1699187449,
                salaryUp: true,
                ...
                dateA: new DateTime(2013, 10, 7),
                dateD: new DateTime(2002, 3, 6),
                sort: 1184207860,
            ...
            await _companyJobContentRepository.InsertAsync(new CompanyJobContent
            (
                id: Guid.Parse("17ba6b01-ffe9-44fe-bc7d-8b689b71b3d2"),
                ...
                peopleRequiredNumber: 1682079813,
                peopleRequiredNumberUnlimited: true,
                ...
                dateA: new DateTime(2018, 8, 2),
                dateD: new DateTime(2018, 9, 2),
                sort: 1718512446,
