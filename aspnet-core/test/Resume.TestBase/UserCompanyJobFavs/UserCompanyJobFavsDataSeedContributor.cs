...
namespace Resume.UserCompanyJobFavs
{
    public class UserCompanyJobFavsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("54ac7130-2d5e-4f45-aa4c-4faa1c552397"),
                ...
                dateA: new DateTime(2004, 1, 2),
                dateD: new DateTime(2009, 4, 5),
                sort: 697159123,
            ...
            await _userCompanyJobFavRepository.InsertAsync(new UserCompanyJobFav
            (
                id: Guid.Parse("e4c8c14c-bbbe-4b89-b183-d898f1b5d612"),
                ...
                dateA: new DateTime(2009, 8, 16),
                dateD: new DateTime(2006, 3, 10),
                sort: 480539592,
