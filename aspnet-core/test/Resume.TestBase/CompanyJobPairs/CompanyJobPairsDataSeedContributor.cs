...
namespace Resume.CompanyJobPairs
{
    public class CompanyJobPairsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("5ba3bd8a-5762-4215-b0e4-6cd1a7585653"),
                ...
                dateA: new DateTime(2013, 7, 24),
                dateD: new DateTime(2007, 5, 4),
                sort: 138165257,
            ...
            await _companyJobPairRepository.InsertAsync(new CompanyJobPair
            (
                id: Guid.Parse("c033aa93-a3c1-4440-9fc1-6337f2f72d32"),
                ...
                dateA: new DateTime(2014, 10, 14),
                dateD: new DateTime(2013, 7, 2),
                sort: 271194786,
