...
namespace Resume.ShareUploads
{
    public class ShareUploadsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("fb3826fa-de51-4f7d-88b8-b1212da6d62c"),
                ...
                dateA: new DateTime(2003, 6, 3),
                dateD: new DateTime(2005, 3, 13),
                sort: 1132567617,
            ...
            await _shareUploadRepository.InsertAsync(new ShareUpload
            (
                id: Guid.Parse("7cc6042b-4732-4f1d-9ee2-e8b720bef084"),
                ...
                dateA: new DateTime(2020, 5, 1),
                dateD: new DateTime(2001, 6, 2),
                sort: 278330349,
