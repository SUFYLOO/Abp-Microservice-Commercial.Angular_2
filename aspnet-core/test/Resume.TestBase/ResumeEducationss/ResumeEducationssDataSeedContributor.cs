...
namespace Resume.ResumeEducationss
{
    public class ResumeEducationssDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("9e5bebf5-eb42-4978-94f7-ed1ecbde07da"),
                ...
                dateA: new DateTime(2014, 8, 24),
                dateD: new DateTime(2018, 7, 7),
                sort: 834768948,
            ...
            await _resumeEducationsRepository.InsertAsync(new ResumeEducations
            (
                id: Guid.Parse("7a2736d3-b8bb-47b1-b3ca-905699c617c0"),
                ...
                dateA: new DateTime(2021, 6, 23),
                dateD: new DateTime(2013, 3, 15),
                sort: 145463191,
