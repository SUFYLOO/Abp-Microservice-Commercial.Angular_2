...
{
    public class ShareSendQueuesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly IShareSendQueueRepository _shareSendQueueRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public ShareSendQueuesDataSeedContributor(IShareSendQueueRepository shareSendQueueRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _shareSendQueueRepository.InsertAsync(new ShareSendQueue
            (
                id: Guid.Parse("f4766396-b2fe-46ea-b8a2-8ca417da37fb"),
                ...
                sucess: true,
                suspend: true,
                dateSend: new DateTime(2017, 1, 21),
                ...
                dateA: new DateTime(2011, 9, 20),
                dateD: new DateTime(2021, 7, 24),
                sort: 1935934498,
            ...
            await _shareSendQueueRepository.InsertAsync(new ShareSendQueue
            (
                id: Guid.Parse("8cd2a324-b761-40bc-881b-f40bf9c4d1e6"),
                ...
                sucess: true,
                suspend: true,
                dateSend: new DateTime(2008, 1, 15),
                ...
                dateA: new DateTime(2005, 5, 17),
                dateD: new DateTime(2007, 6, 12),
                sort: 452710908,
