...
namespace Resume.ShareSendQueues
{
    public class ShareSendQueuesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("7cd5a756-350e-4118-9af4-af184e0ffa22"),
                ...
                sucess: true,
                suspend: true,
                dateSend: new DateTime(2009, 3, 4),
                ...
                dateA: new DateTime(2013, 1, 14),
                dateD: new DateTime(2019, 8, 19),
                sort: 617059994,
            ...
            await _shareSendQueueRepository.InsertAsync(new ShareSendQueue
            (
                id: Guid.Parse("fb84997b-f71a-4c91-9704-f40cbd1e9143"),
                ...
                sucess: true,
                suspend: true,
                dateSend: new DateTime(2012, 8, 19),
                ...
                dateA: new DateTime(2000, 9, 16),
                dateD: new DateTime(2011, 9, 6),
                sort: 1547159080,
