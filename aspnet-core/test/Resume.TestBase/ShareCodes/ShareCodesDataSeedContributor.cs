...
namespace Resume.ShareCodes
{
    public class ShareCodesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("5ef88947-59f1-40d6-9324-7ebd7846c4ec"),
                ...
                dateA: new DateTime(2006, 10, 13),
                dateD: new DateTime(2008, 8, 3),
                sort: 17222691,
            ...
            await _shareCodeRepository.InsertAsync(new ShareCode
            (
                id: Guid.Parse("e716cda3-8d45-45a9-925a-9a3c4d353845"),
                ...
                dateA: new DateTime(2002, 1, 7),
                dateD: new DateTime(2015, 11, 5),
                sort: 1136587141,
