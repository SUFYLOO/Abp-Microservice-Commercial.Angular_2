...
namespace Resume.TradeOrders
{
    public class TradeOrdersDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("40f7ff75-5653-4e38-b446-48b35f6a67eb"),
                keyId: Guid.Parse("1043387e-fc92-46ac-ad21-6ddfc1cc7a4a"),
                orderNumber: "bda33824f7f74dc980269d88f87fe621bfbc8ffe2d374bf7b0",
                dateOrder: new DateTime(2008, 5, 5),
                dateNeed: new DateTime(2016, 9, 26),
                dateDelivery: new DateTime(2009, 8, 21),
                ...
                dateA: new DateTime(2006, 9, 4),
                dateD: new DateTime(2013, 6, 3),
                sort: 340320336,
            ...
            await _tradeOrderRepository.InsertAsync(new TradeOrder
            (
                id: Guid.Parse("875aea5d-a415-4138-862c-b1b278e3b70c"),
                keyId: Guid.Parse("88c14f0f-4d04-473f-b226-222429e4c597"),
                orderNumber: "d3951e092fe9442abce583f7a3a99a164f9961e4ff1540c5b4",
                dateOrder: new DateTime(2009, 3, 14),
                dateNeed: new DateTime(2019, 11, 2),
                dateDelivery: new DateTime(2016, 6, 24),
                ...
                dateA: new DateTime(2003, 5, 5),
                dateD: new DateTime(2022, 1, 6),
                sort: 902763797,
