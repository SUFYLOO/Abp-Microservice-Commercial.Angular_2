...
namespace Resume.SystemTables
{
    public class SystemTablesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("2caf691c-41e9-494d-96d5-2b54a5c93218"),
                ...
                dateA: new DateTime(2020, 2, 11),
                dateD: new DateTime(2015, 7, 22),
                sort: 1258272214,
            ...
            await _systemTableRepository.InsertAsync(new SystemTable
            (
                id: Guid.Parse("8726b177-93cf-439d-ac98-98d67b0db868"),
                ...
                dateA: new DateTime(2014, 10, 20),
                dateD: new DateTime(2014, 5, 24),
                sort: 1659663056,
