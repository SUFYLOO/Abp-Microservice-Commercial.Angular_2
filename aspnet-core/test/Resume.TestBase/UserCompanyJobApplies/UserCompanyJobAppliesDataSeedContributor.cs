...
namespace Resume.UserCompanyJobApplies
{
    public class UserCompanyJobAppliesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("99367996-2cdf-4c2f-81d3-3a780f32c40c"),
                ...
                dateA: new DateTime(2013, 8, 11),
                dateD: new DateTime(2000, 11, 14),
                sort: 1765482885,
            ...
            await _userCompanyJobApplyRepository.InsertAsync(new UserCompanyJobApply
            (
                id: Guid.Parse("61ed38a5-97d2-4af8-8f97-5b6dbc616e4f"),
                ...
                dateA: new DateTime(2020, 5, 11),
                dateD: new DateTime(2015, 6, 15),
                sort: 172345873,
