...
namespace Resume.CompanyPointss
{
    public class CompanyPointssDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("c7ad5219-1a51-4ee0-9663-867bf7ab0577"),
                ...
                dateA: new DateTime(2012, 9, 3),
                dateD: new DateTime(2011, 8, 10),
                sort: 70312113,
            ...
            await _companyPointsRepository.InsertAsync(new CompanyPoints
            (
                id: Guid.Parse("e8a1bcdc-7775-4515-bd66-930426401efc"),
                ...
                dateA: new DateTime(2010, 5, 2),
                dateD: new DateTime(2006, 1, 16),
                sort: 1426006832,
