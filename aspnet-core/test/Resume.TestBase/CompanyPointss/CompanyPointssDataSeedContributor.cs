...
namespace Resume.CompanyPointss
{
    public class CompanyPointssDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("bcde3f61-9faf-4896-8adf-e781e2c9baec"),
                ...
                dateA: new DateTime(2009, 7, 2),
                dateD: new DateTime(2000, 7, 16),
                sort: 665858763,
            ...
            await _companyPointsRepository.InsertAsync(new CompanyPoints
            (
                id: Guid.Parse("10a44f11-a205-43c3-9b27-51bf9bb61873"),
                ...
                dateA: new DateTime(2011, 9, 6),
                dateD: new DateTime(2013, 4, 14),
                sort: 893074572,
