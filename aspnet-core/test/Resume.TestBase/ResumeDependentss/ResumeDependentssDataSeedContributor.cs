...
namespace Resume.ResumeDependentss
{
    public class ResumeDependentssDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("c68600f7-5537-438a-af64-8db308fcaf3e"),
                ...
                birthDate: new DateTime(2009, 7, 24),
                ...
                dateA: new DateTime(2015, 10, 21),
                dateD: new DateTime(2009, 10, 6),
                sort: 828815687,
            ...
            await _resumeDependentsRepository.InsertAsync(new ResumeDependents
            (
                id: Guid.Parse("4d423bad-e63a-415b-a198-4485d0faf423"),
                ...
                birthDate: new DateTime(2022, 5, 13),
