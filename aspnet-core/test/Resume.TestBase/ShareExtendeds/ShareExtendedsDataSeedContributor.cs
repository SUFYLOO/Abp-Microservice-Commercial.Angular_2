...
{
    public class ShareExtendedsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly IShareExtendedRepository _shareExtendedRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public ShareExtendedsDataSeedContributor(IShareExtendedRepository shareExtendedRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _shareExtendedRepository.InsertAsync(new ShareExtended
            (
                id: Guid.Parse("3b22c00d-eb3e-40d0-8964-ee7d4ff1e0d4"),
                ...
                dateA: new DateTime(2010, 5, 22),
                dateD: new DateTime(2003, 9, 26),
                sort: 807083584,
            ...
            await _shareExtendedRepository.InsertAsync(new ShareExtended
            (
                id: Guid.Parse("093df82e-ff9c-42eb-98a0-2e708f5027f8"),
                ...
                dateA: new DateTime(2010, 7, 25),
                dateD: new DateTime(2012, 9, 16),
                sort: 1840825380,
