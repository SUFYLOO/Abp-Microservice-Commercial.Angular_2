...
namespace Resume.UserInfos
{
    public class UserInfosDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("45110c14-515a-4a15-8f5f-5712ec0741b9"),
                ...
                birthDate: new DateTime(2020, 3, 18),
                ...
                dateA: new DateTime(2007, 2, 2),
                dateD: new DateTime(2006, 1, 9),
                sort: 146688462,
            ...
            await _userInfoRepository.InsertAsync(new UserInfo
            (
                id: Guid.Parse("04945beb-0932-4223-8f3b-164de24900b5"),
                ...
                birthDate: new DateTime(2012, 5, 2),
                ...
                dateA: new DateTime(2011, 8, 17),
                dateD: new DateTime(2014, 5, 1),
                sort: 885169632,
