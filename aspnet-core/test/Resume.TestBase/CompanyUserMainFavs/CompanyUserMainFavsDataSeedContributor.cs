...
namespace Resume.CompanyUserMainFavs
{
    public class CompanyUserMainFavsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("bd70bbf9-70ee-49ba-9932-364f3ee9ca2c"),
                ...
                dateA: new DateTime(2020, 10, 25),
                dateD: new DateTime(2012, 1, 17),
                sort: 1782909077,
            ...
            await _companyUserMainFavRepository.InsertAsync(new CompanyUserMainFav
            (
                id: Guid.Parse("f9a4614c-41bd-4cff-9ba7-9ac58a375b24"),
                ...
                dateA: new DateTime(2006, 4, 21),
                dateD: new DateTime(2004, 10, 2),
                sort: 2114185503,
