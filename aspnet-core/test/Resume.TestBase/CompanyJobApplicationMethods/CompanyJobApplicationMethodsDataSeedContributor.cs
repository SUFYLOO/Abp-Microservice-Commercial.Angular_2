...
{
    public class CompanyJobApplicationMethodsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly ICompanyJobApplicationMethodRepository _companyJobApplicationMethodRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public CompanyJobApplicationMethodsDataSeedContributor(ICompanyJobApplicationMethodRepository companyJobApplicationMethodRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _companyJobApplicationMethodRepository.InsertAsync(new CompanyJobApplicationMethod
            (
                id: Guid.Parse("49bc66cd-19b2-42d7-8099-45b775e266ae"),
                ...
                dateA: new DateTime(2021, 10, 4),
                dateD: new DateTime(2005, 5, 20),
                sort: 915533972,
            ...
            await _companyJobApplicationMethodRepository.InsertAsync(new CompanyJobApplicationMethod
            (
                id: Guid.Parse("ed46678e-5e14-484e-a64b-a70547eed0ad"),
                ...
                dateA: new DateTime(2005, 11, 16),
                dateD: new DateTime(2007, 9, 21),
                sort: 919237608,
