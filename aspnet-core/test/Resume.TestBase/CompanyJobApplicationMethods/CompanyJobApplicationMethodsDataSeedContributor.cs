...
namespace Resume.CompanyJobApplicationMethods
{
    public class CompanyJobApplicationMethodsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("ad773da8-2889-48e9-821c-9cb2b68bb64c"),
                ...
                dateA: new DateTime(2019, 11, 18),
                dateD: new DateTime(2010, 10, 8),
                sort: 1394726313,
            ...
            await _companyJobApplicationMethodRepository.InsertAsync(new CompanyJobApplicationMethod
            (
                id: Guid.Parse("ce0ad290-1aa6-48c6-b398-59c2a73d3ce3"),
                ...
                dateA: new DateTime(2017, 9, 1),
                dateD: new DateTime(2005, 10, 9),
                sort: 1831918580,
