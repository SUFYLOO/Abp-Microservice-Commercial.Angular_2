...
namespace Resume.ResumeDrvingLicenses
{
    public class ResumeDrvingLicensesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("7a9d295c-df62-4a93-8392-f2bc31c93941"),
                ...
                dateA: new DateTime(2003, 5, 14),
                dateD: new DateTime(2014, 4, 1),
                sort: 98099712,
            ...
            await _resumeDrvingLicenseRepository.InsertAsync(new ResumeDrvingLicense
            (
                id: Guid.Parse("cfd2bcec-0fba-4f0c-ac3e-fd882691ea60"),
                ...
                dateA: new DateTime(2013, 8, 8),
                dateD: new DateTime(2014, 1, 1),
                sort: 307253326,
