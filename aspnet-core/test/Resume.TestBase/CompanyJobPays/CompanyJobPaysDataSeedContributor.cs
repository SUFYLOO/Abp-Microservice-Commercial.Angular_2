...
namespace Resume.CompanyJobPays
{
    public class CompanyJobPaysDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("c3d4d298-9677-4a4b-81bb-9d52f1940af7"),
                ...
                dateReal: new DateTime(2005, 8, 17),
                isCancel: true,
                ...
                dateA: new DateTime(2018, 2, 23),
                dateD: new DateTime(2005, 4, 11),
                sort: 1196198356,
            ...
            await _companyJobPayRepository.InsertAsync(new CompanyJobPay
            (
                id: Guid.Parse("30cacfdc-f173-4c11-a040-798b88041d7e"),
                ...
                dateReal: new DateTime(2012, 10, 5),
                isCancel: true,
                ...
                dateA: new DateTime(2001, 11, 26),
                dateD: new DateTime(2016, 9, 20),
                sort: 617151841,
