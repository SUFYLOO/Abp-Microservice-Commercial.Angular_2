...
namespace Resume.CompanyJobPays
{
    public class CompanyJobPaysDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("962b796a-276a-4d08-8aff-6f8dfa637d07"),
                ...
                dateReal: new DateTime(2007, 9, 17),
                isCancel: true,
                ...
                dateA: new DateTime(2017, 3, 14),
                dateD: new DateTime(2007, 9, 16),
                sort: 244104006,
            ...
            await _companyJobPayRepository.InsertAsync(new CompanyJobPay
            (
                id: Guid.Parse("8e061fe3-a0fc-4cd5-bec3-c8a31d5c506b"),
                ...
                dateReal: new DateTime(2015, 1, 22),
                isCancel: true,
                ...
                dateA: new DateTime(2016, 1, 1),
                dateD: new DateTime(2021, 6, 4),
                sort: 1837157171,
