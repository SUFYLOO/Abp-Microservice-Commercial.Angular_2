...
namespace Resume.CompanyInvitationsCodes
{
    public class CompanyInvitationsCodesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("e2234963-8d1b-443a-85ea-db7221aae648"),
            ...
            await _companyInvitationsCodeRepository.InsertAsync(new CompanyInvitationsCode
            (
                id: Guid.Parse("9db48014-78cd-47f0-845e-485174a45710"),
                ...
                dateA: new DateTime(2019, 8, 15),
                dateD: new DateTime(2010, 6, 1),
                sort: 2058234574,
