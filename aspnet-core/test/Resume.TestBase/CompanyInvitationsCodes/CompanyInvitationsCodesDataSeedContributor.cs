...
{
    public class CompanyInvitationsCodesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly ICompanyInvitationsCodeRepository _companyInvitationsCodeRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public CompanyInvitationsCodesDataSeedContributor(ICompanyInvitationsCodeRepository companyInvitationsCodeRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _companyInvitationsCodeRepository.InsertAsync(new CompanyInvitationsCode
            (
                id: Guid.Parse("a1969ca7-0070-4962-b3e5-6907e586f53c"),
                ...
                dateA: new DateTime(2010, 10, 9),
                dateD: new DateTime(2011, 1, 16),
                sort: 1136714721,
            ...
            await _companyInvitationsCodeRepository.InsertAsync(new CompanyInvitationsCode
            (
                id: Guid.Parse("d748a59c-81e7-45c6-925a-c290fbe552ff"),
                ...
                dateA: new DateTime(2020, 7, 8),
                dateD: new DateTime(2008, 7, 13),
                sort: 521908944,
