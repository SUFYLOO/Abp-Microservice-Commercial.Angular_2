...
namespace Resume.CompanyInvitationss
{
    public class CompanyInvitationssDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("5c7012d9-716d-442d-ad79-ce1c0907b86d"),
                ...
                dateA: new DateTime(2018, 3, 2),
                dateD: new DateTime(2001, 9, 19),
                sort: 424024299,
            ...
            await _companyInvitationsRepository.InsertAsync(new CompanyInvitations
            (
                id: Guid.Parse("99abf58f-5856-4d08-b241-1c75c7b53b09"),
                ...
                dateA: new DateTime(2003, 1, 7),
                dateD: new DateTime(2019, 2, 9),
                sort: 786698007,
