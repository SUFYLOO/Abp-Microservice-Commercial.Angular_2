...
namespace Resume.UserAccountBinds
{
    public class UserAccountBindsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("21e28c73-20bd-453b-a731-422fde5b0ebb"),
                ...
                dateA: new DateTime(2002, 5, 11),
                dateD: new DateTime(2022, 6, 14),
                sort: 1447528893,
            ...
            await _userAccountBindRepository.InsertAsync(new UserAccountBind
            (
                id: Guid.Parse("e8dd1652-9534-47ac-ae5a-62500ce2a943"),
                ...
                dateA: new DateTime(2022, 1, 26),
                dateD: new DateTime(2016, 6, 19),
                sort: 413441965,
