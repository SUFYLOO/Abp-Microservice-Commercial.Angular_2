...
namespace Resume.CompanyUsers
{
    public class CompanyUsersDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("18371266-a376-4ba4-a518-ce6aece5ab88"),
                ...
                dateA: new DateTime(2000, 2, 21),
                dateD: new DateTime(2010, 8, 6),
                sort: 441710264,
            ...
            await _companyUserRepository.InsertAsync(new CompanyUser
            (
                id: Guid.Parse("6cd2ec68-bd6f-4f06-b9af-2ef8d97b3dc0"),
                ...
                dateA: new DateTime(2001, 2, 15),
                dateD: new DateTime(2016, 7, 6),
                sort: 861265268,
