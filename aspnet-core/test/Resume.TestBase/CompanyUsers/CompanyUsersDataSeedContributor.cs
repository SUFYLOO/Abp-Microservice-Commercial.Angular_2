...
{
    public class CompanyUsersDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly ICompanyUserRepository _companyUserRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public CompanyUsersDataSeedContributor(ICompanyUserRepository companyUserRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _companyUserRepository.InsertAsync(new CompanyUser
            (
                id: Guid.Parse("a2e6c164-6fe0-4914-bd80-c8b069161ad1"),
                ...
                dateA: new DateTime(2020, 8, 14),
                dateD: new DateTime(2010, 8, 25),
                sort: 1644825611,
            ...
            await _companyUserRepository.InsertAsync(new CompanyUser
            (
                id: Guid.Parse("516eea04-6864-4c5c-8789-4b4a33773d65"),
                ...
                dateA: new DateTime(2018, 11, 20),
                dateD: new DateTime(2003, 4, 23),
                sort: 188980221,
