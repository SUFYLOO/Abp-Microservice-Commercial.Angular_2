...
namespace Resume.ResumeWorkss
{
    public class ResumeWorkssDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("a2626a9f-35a8-4510-b711-a0d29368c24d"),
                ...
                dateA: new DateTime(2015, 5, 4),
                dateD: new DateTime(2000, 10, 14),
                sort: 1570116281,
            ...
            await _resumeWorksRepository.InsertAsync(new ResumeWorks
            (
                id: Guid.Parse("c9948a48-83b8-4305-88a8-1d9185e04c69"),
                ...
                dateA: new DateTime(2011, 9, 2),
                dateD: new DateTime(2000, 9, 9),
                sort: 411587244,
