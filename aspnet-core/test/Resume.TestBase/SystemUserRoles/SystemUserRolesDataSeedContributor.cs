...
namespace Resume.SystemUserRoles
{
    public class SystemUserRolesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("c537b127-dce4-451c-aaa7-4af998dee557"),
                ...
                dateA: new DateTime(2010, 11, 19),
                dateD: new DateTime(2004, 2, 23),
                sort: 770521460,
            ...
            await _systemUserRoleRepository.InsertAsync(new SystemUserRole
            (
                id: Guid.Parse("d2f74e71-88db-4480-9ab3-8bafb90c9d5b"),
                ...
                dateA: new DateTime(2022, 6, 13),
                dateD: new DateTime(2019, 4, 21),
                sort: 976248576,
