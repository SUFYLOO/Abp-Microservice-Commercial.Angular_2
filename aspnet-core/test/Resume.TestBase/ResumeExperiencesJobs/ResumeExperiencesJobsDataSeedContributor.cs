...
namespace Resume.ResumeExperiencesJobs
{
    public class ResumeExperiencesJobsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("e57d262d-5c13-4a85-96fe-9387d2680415"),
                ...
                dateA: new DateTime(2005, 10, 14),
                dateD: new DateTime(2022, 5, 11),
                sort: 1651192766,
            ...
            await _resumeExperiencesJobRepository.InsertAsync(new ResumeExperiencesJob
            (
                id: Guid.Parse("bef1c89c-664b-496c-a20b-0c5838ad6ddc"),
                ...
                dateA: new DateTime(2007, 11, 27),
                dateD: new DateTime(2014, 1, 14),
                sort: 454754007,
