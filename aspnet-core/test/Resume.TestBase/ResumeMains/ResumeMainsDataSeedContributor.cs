...
namespace Resume.ResumeMains
{
    public class ResumeMainsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("fbad2b8c-db3d-4bb2-aa67-745c177b2834"),
                ...
                dateA: new DateTime(2005, 7, 8),
                dateD: new DateTime(2018, 9, 24),
                sort: 573999182,
            ...
            await _resumeMainRepository.InsertAsync(new ResumeMain
            (
                id: Guid.Parse("f4d7ae49-5c98-43b1-b6ef-6673b53ab6e3"),
                ...
                dateA: new DateTime(2010, 7, 2),
                dateD: new DateTime(2020, 1, 19),
                sort: 1098896259,
