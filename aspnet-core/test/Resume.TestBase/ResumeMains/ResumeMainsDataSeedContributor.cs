...
{
    public class ResumeMainsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly IResumeMainRepository _resumeMainRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public ResumeMainsDataSeedContributor(IResumeMainRepository resumeMainRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _resumeMainRepository.InsertAsync(new ResumeMain
            (
                id: Guid.Parse("a67ce190-d438-4bc4-91fb-0b44c428d4f8"),
                ...
                dateA: new DateTime(2016, 10, 8),
                dateD: new DateTime(2011, 1, 22),
                sort: 1532676003,
            ...
            await _resumeMainRepository.InsertAsync(new ResumeMain
            (
                id: Guid.Parse("b5451f90-2130-4d42-a75c-ab93074096c3"),
                ...
                dateA: new DateTime(2005, 4, 1),
                dateD: new DateTime(2014, 8, 25),
                sort: 1557331301,
