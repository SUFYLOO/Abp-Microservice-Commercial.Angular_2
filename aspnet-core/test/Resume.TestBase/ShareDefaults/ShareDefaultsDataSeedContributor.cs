...
namespace Resume.ShareDefaults
{
    public class ShareDefaultsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("08a23b4d-27e2-40dd-8d4e-104c01f4518b"),
                ...
                dateA: new DateTime(2019, 4, 22),
                dateD: new DateTime(2022, 10, 10),
                sort: 1139607921,
            ...
            await _shareDefaultRepository.InsertAsync(new ShareDefault
            (
                id: Guid.Parse("858cd8e6-dceb-47d0-9ebd-6b367fea5e1f"),
                ...
                dateA: new DateTime(2011, 6, 9),
                dateD: new DateTime(2015, 11, 14),
                sort: 73223969,
