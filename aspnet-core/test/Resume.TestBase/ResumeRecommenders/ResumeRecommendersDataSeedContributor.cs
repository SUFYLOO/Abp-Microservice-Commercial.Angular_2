...
{
    public class ResumeRecommendersDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly IResumeRecommenderRepository _resumeRecommenderRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public ResumeRecommendersDataSeedContributor(IResumeRecommenderRepository resumeRecommenderRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _resumeRecommenderRepository.InsertAsync(new ResumeRecommender
            (
                id: Guid.Parse("16d6a365-f3bd-4137-84a1-e1faac07ca4c"),
                ...
                dateA: new DateTime(2013, 4, 27),
                dateD: new DateTime(2021, 7, 2),
                sort: 104484548,
            ...
            await _resumeRecommenderRepository.InsertAsync(new ResumeRecommender
            (
                id: Guid.Parse("e9c5fbc1-d435-4244-8d0c-afda706874d2"),
                ...
                dateA: new DateTime(2010, 11, 27),
                dateD: new DateTime(2006, 7, 9),
                sort: 1387940555,
