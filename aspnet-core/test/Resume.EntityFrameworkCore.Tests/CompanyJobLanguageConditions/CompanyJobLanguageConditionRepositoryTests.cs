...
{
    public class CompanyJobLanguageConditionRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly ICompanyJobLanguageConditionRepository _companyJobLanguageConditionRepository;

        public CompanyJobLanguageConditionRepositoryTests()
        {
            _companyJobLanguageConditionRepository = GetRequiredService<ICompanyJobLanguageConditionRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _companyJobLanguageConditionRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("7327c408-6efa-4969-b93e-e2874e9359fd"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _companyJobLanguageConditionRepository.GetCountAsync(
