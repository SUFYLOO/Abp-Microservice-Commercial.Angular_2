...
{
    public class SystemColumnRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly ISystemColumnRepository _systemColumnRepository;

        public SystemColumnRepositoryTests()
        {
            _systemColumnRepository = GetRequiredService<ISystemColumnRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _systemColumnRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("f2520c54-cbb1-4944-9daf-d0a42ebe8a5e"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _systemColumnRepository.GetCountAsync(
