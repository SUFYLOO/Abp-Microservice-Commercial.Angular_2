...
{
    public class ShareTagRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly IShareTagRepository _shareTagRepository;

        public ShareTagRepositoryTests()
        {
            _shareTagRepository = GetRequiredService<IShareTagRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _shareTagRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("acc48ed4-aaf9-45f4-8b0b-925c68da7bee"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _shareTagRepository.GetCountAsync(
