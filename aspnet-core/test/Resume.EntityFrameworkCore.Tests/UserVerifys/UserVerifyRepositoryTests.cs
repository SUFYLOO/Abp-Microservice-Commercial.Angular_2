...
{
    public class UserVerifyRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly IUserVerifyRepository _userVerifyRepository;

        public UserVerifyRepositoryTests()
        {
            _userVerifyRepository = GetRequiredService<IUserVerifyRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _userVerifyRepository.GetListAsync(
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _userVerifyRepository.GetCountAsync(
