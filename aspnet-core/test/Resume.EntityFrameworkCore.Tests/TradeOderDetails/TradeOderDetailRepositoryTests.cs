...
{
    public class TradeOderDetailRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly ITradeOderDetailRepository _tradeOderDetailRepository;

        public TradeOderDetailRepositoryTests()
        {
            _tradeOderDetailRepository = GetRequiredService<ITradeOderDetailRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _tradeOderDetailRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("8f0804e5-0fb3-4312-be5f-be91f1cdbc79"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _tradeOderDetailRepository.GetCountAsync(
