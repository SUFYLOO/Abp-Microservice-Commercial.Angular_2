...
{
    public class SystemValidateRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly ISystemValidateRepository _systemValidateRepository;

        public SystemValidateRepositoryTests()
        {
            _systemValidateRepository = GetRequiredService<ISystemValidateRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _systemValidateRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("aa5f7c08-9d41-4798-b084-34ec7b84eebd"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _systemValidateRepository.GetCountAsync(
