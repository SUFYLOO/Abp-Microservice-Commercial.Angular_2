...
{
    public class ResumeLanguageRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly IResumeLanguageRepository _resumeLanguageRepository;

        public ResumeLanguageRepositoryTests()
        {
            _resumeLanguageRepository = GetRequiredService<IResumeLanguageRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _resumeLanguageRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("ab71f01e-45be-4326-9b65-e19d5fa8d996"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _resumeLanguageRepository.GetCountAsync(
