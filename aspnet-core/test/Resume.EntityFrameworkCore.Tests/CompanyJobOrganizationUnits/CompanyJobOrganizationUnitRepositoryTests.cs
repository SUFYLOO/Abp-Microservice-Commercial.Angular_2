...
{
    public class CompanyJobOrganizationUnitRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly ICompanyJobOrganizationUnitRepository _companyJobOrganizationUnitRepository;

        public CompanyJobOrganizationUnitRepositoryTests()
        {
            _companyJobOrganizationUnitRepository = GetRequiredService<ICompanyJobOrganizationUnitRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.First().Id.ShouldBe(Guid.Parse("e96d8376-0604-4ce2-bc33-0907aebfbe5d"));
            });
        }
