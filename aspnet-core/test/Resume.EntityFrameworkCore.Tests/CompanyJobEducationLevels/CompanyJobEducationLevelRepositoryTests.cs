...
{
    public class CompanyJobEducationLevelRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly ICompanyJobEducationLevelRepository _companyJobEducationLevelRepository;

        public CompanyJobEducationLevelRepositoryTests()
        {
            _companyJobEducationLevelRepository = GetRequiredService<ICompanyJobEducationLevelRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _companyJobEducationLevelRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("36d96305-8706-4aba-a92a-aa7ac11db346"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _companyJobEducationLevelRepository.GetCountAsync(
