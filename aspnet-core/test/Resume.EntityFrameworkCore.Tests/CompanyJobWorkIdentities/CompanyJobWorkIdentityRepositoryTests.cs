...
{
    public class CompanyJobWorkIdentityRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly ICompanyJobWorkIdentityRepository _companyJobWorkIdentityRepository;

        public CompanyJobWorkIdentityRepositoryTests()
        {
            _companyJobWorkIdentityRepository = GetRequiredService<ICompanyJobWorkIdentityRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _companyJobWorkIdentityRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("83571cb8-40a3-4644-95ac-640f6f19f559"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _companyJobWorkIdentityRepository.GetCountAsync(
