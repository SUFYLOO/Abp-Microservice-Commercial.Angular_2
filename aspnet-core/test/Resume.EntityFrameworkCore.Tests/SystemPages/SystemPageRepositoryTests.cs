...
{
    public class SystemPageRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly ISystemPageRepository _systemPageRepository;

        public SystemPageRepositoryTests()
        {
            _systemPageRepository = GetRequiredService<ISystemPageRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _systemPageRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("015b50bc-baa5-49f6-beb1-b47c4ba81a7b"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _systemPageRepository.GetCountAsync(
