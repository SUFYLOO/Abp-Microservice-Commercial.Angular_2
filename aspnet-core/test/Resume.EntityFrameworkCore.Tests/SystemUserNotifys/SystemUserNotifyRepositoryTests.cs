...
{
    public class SystemUserNotifyRepositoryTests : ResumeEntityFrameworkCoreTestBase
    {
        private readonly ISystemUserNotifyRepository _systemUserNotifyRepository;

        public SystemUserNotifyRepositoryTests()
        {
            _systemUserNotifyRepository = GetRequiredService<ISystemUserNotifyRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _systemUserNotifyRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("a8081e2e-2fda-4528-82a9-437ba2b6416b"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _systemUserNotifyRepository.GetCountAsync(
